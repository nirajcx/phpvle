...
{
		$sql = "insert into login_lawyer(username,lno,password,emailid,phoneno,nameorg) values('$username', $lno,'$password','$email',$phone,'$name')";
		$res=$conn->query($sql);
		echo "insert done";
    $sql1="select bid from login_lawyer where username='$username'";
...
<tr>
<td colspan=2>
<center><font size=5><b>LAWYER REGISTER</b></font></center>
</td>
</tr>
